          ...
          <div className="flex-1 px-16">
            <div className="bg-gray-900 flex flex-col p-6 rounded-lg items-center">
                ...
                <div className="flex flex-col space-y-2 w-full my-2">
                  ...
                  <input name="Description" type="email" value={description} onChange={(e)=>setDescription(e.target.value)} required className="w-full px-3 py-2 placeholder-gray-500 text-gray-900 focus:outline-none" placeholder="Description"/>
                </div>
